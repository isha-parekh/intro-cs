...
void draw() {
  ...
  for(int counter=1; counter <= 10; counter= counter+2){
    float xCenter= 100 * counter;
   tower(xCenter, 500, 400, "person", color(222, 135, 12));
  }
  for(int counter2=2; counter2 <= 10; counter2= counter2+2){
    float xCenter= 100 * counter2;
   tower(xCenter, 500, 200, "kitty", color(124, 166, 233));
  }
}
